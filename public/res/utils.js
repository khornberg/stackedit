define([
    ...
    utils.saveAsPdf = function(content, filename) {
        try {
            ...
            ,
                source = content //$('#preview-contents')[0]
            ...
            //TODO Add error message saying PDF could not be created
            //Tried eventMgr.onError(e); but I've given a not defined error
            //Tried adding to the top but given another error in the console
